...
$\chi^2$                               & 2.25                        & 5.31                     \\
D.O.F                                  & 2                           & 3                        \\
$T$                       & 63.09$^{+1.08}_{-1.31}$     & 51.95$^{+1.26}_{-1.21}$  \\
$\beta$                                & 1.90$^{+0.57}_{-0.53}$      & 0.7$^{+0.24}_{-0.26}$    \\
$\alpha$                               & 2.94$^{+0.31}_{-0.40}$      & 2.76$^{+0.23}_{-0.23}$   \\
$\lambda_0$\tna           & 248.70$^{+85.96}_{-123.77}$ & ---                      \\
$\lambda_{\rm peak}$ \tnb & 254.7$^{+6.2}_{-6.1}$       & 301.4$^{+29.0}_{-30.1}$  \\
$f_{\rm norm}$\tnc      & 267.41$^{+16.67}_{-16.31}$  & 244.25$^{15.28}_{15.30}$ \\
$L_{\rm IR}$\tnd         & 88.52$^{+2.62}_{-2.63}$     & 89.15                    \\
$M_{\rm d}$\tne          & 50.47$^{+20.42}_{-20.15}$   & 25.74$^{+3.88}_{-5.49}$
\enddata
% Optically thick & 18.91 & 1.35 & 722.81 & 3.05 & 254.7 & 88.52 & 50.47 \\
% Optically thin &  16.13 & 0.7 & N/A   & 2.76 & 301.4 & 89.15 & 25.74
\label{tab:mbb}
\tablenotetext{a}{The rest-frame wavelength in units of $\micron$ where the dust becomes optically thick, upper limit is 2000 $\micron$}
\tablenotetext{b}{Observed-frame wavelength in units of $\micron$}
\tablenotetext{c}{Observed-frame flux density at 500 $\micron$}
\tablenotetext{d}{Rest-frame 8-1000 $\micron$ luminosity in units of 10$^{12}$ \Lsun}
\tablenotetext{e}{Dust mass in units of 10$^8$ M$_\odot$, derived assuming standard absorption mass coefficient $\kappa$=2.64 m$^2$ kg$^{-1}$ at $\lambda$=125.0 $\micron$ \citep{Dunne03a}, without lensing correction}
