...
$\lambda_0$\tablenotemark{a} & 224.41$^{+85.96}_{-123.77}$ & --- \\
$\lambda_{\rm peak}$ \tablenotemark{b} & 254.7$^{+6.2}_{-6.1}$ & 301.4$^{+29.0}_{-30.1}$ \\
$f_{\rm norm}$ \tablenotemark{c} & 255.79$^{+16.67}_{-16.31}$ & 244.25$^{15.28}_{15.30}$ \\
$L_{\rm IR}$\tablenotemark{d} & 88.52$^{+2.62}_{-2.63}$ & 89.15 \\
$M_{\rm d}$\tablenotemark{e} & 50.47$^{+20.42}_{-20.15}$ & 25.74$^{+3.88}_{-5.49}$
\enddata
...
\tablenotetext{d}{Rest-frame 8-1000 $\micron$ luminosity in units of 10$^{12}$ L$_\sun$}
