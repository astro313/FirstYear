...
\colhead{Ref.} \vspace{0.05in}
\\  \cline{1-5} \vspace{-0.05in} \\
\multicolumn{5}{c}{Integrated}
}
\startdata
    104.2 & GHz & 7.39 $\pm$ 1.42\tna        & mJy & This work \\
...
\cutinhead{Core Only}
    104.2 & GHz & $<$ 2.29 		      & mJy & This work \\
    9.0   & GHz & 0.80  $\pm$ 0.06    & mJy & H14       \\
    4.86  & GHz & $<$ 0.17            & mJy & M06       \\
\enddata
\label{tab:SEDdataRadio}
\tablenotetext{a}{Integrated flux density. Peak flux density of the continuum emission is 4.93 $\pm$ 0.31 mJy}
