...
$f_{\rm gas-dyn}$ && 0.3 $\pm$ 0.1 & 0.9\tnf\tni & --- & 0.6 $\pm$ 0.1 & S11 \\
\enddata
\label{tab:comapreSMG}
\tablenotetext{a}{H14}
\tablenotetext{b}{\CO}
\tablenotetext{c}{Estimated from Figure 1 in D11}
\tablenotetext{d}{Chabrier IMF}
\tablenotetext{e}{Errors include uncertainties on $\mu_{\rm L}$}
\tablenotetext{f}{We derive this using the reported values}
\tablenotetext{g}{Converted theirs values derived using Salpeter IMF to Chabrier IMF}
