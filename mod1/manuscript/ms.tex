...
\input{changelog.tex}       % git revision hash, new command

\shorttitle{Study of a strongly-lensed type-2 quasar host SMG at $z$\,=\,2.221}
\shortauthors{Leung \& Riechers}

\begin{document}
{\tiny  \RevisionInfo}        % place it here
\title{A Massive Molecular Gas Reservoir in the $z$\,=\,2.221 Type-2 Qruasar Host Galaxy SMM\,J0939+8315 lensed by the Radio Galaxy 3C220.3}
...
Using the \CO line intensity of $I_\textrm{CO(3-2)}$ = (12.6\,$\pm$\,2.0)\,Jy\,km\,s\pmOne, we derive
 ...
 % performed on the 1\,mm continuum emission.
...
We find that the properties of the interstellar medium of
 SMM J0939+8315 overlap with both SMGs and type-2 quasars. Hence, SMM J0939+8315 may be transitioning from its star-bursting phase to the unobscured quasar phase in the 
evolutionary link model, according in which this SMG represents an intermediate stage of present-day galaxies
at an earlier epoch. 
 }
\end{abstract}
...
{\bf Following the pioneering works in the discovery of this population \citep{Barger98a,Smail97a,Hughes98a}}, considerable amounts of effort have been invested into 
...
A particularly interesting and peculiar lensing system was discovered serendipitously in a study carried out with {\it Herschel}, in which
...
companion galaxy B as seen in Keck 2$\micron$ and the {\it Hubble Space Telescope} 702nm images \citep[hereafter H14]{Haas14}}.
...
{\bf Detections of C~{\scriptsize\sc IV}~1459\AA\
 ...
 placed the redshift of this galaxy at $z$\,=\,2.221. Based on the line fluxes and spectral line widths of these AGN lines, H14 suggest the presence of an active galactic nucleus (AGN) in the form of a type-2 quasar in this SMG.}
...
{\bf The surface mass densities of the two lensing galaxies, 3C220.3 and its companion galaxy B as mentioned in Section~\ref{sec:intro}, are described by singular isothermal ellipsoid profiles, and the source is assumed to have an
...
the foreground radio galaxy contributes a non-negligible amount to the MIR luminosity, we do not fit an AGN component.
Instead, we adopt a power-law to account for the MIR excess, which allows us to estimate the IR
luminosity \citep{Casey12a, Riechers13a, Kirkpatrick15a}. }. 
...
{\bf 
Our lens model infer a half-light radius of $r_s$\,$\sim$\,1\,kpc for the dust-emitting region in SMM\,J0939. This is comparable to those found in the 
samples of SMGs with high resolution imaging. In particular, \citet{Simpson15a} report a radial extent of 1.2 kpc in a sample un-lensed SMGs with $S_{\rm 850}$ = 8$-$16 mJy, a similar size has also been reported by  \citet{Bussmann13a} of 1.5 kpc in a sample of {\it Herschel}$-$selected lensed SMGs with $S_{500} >$ 100 mJy. }
...
We find a dynamical mass of $M_\textrm{dyn}$ = (7.84\,$\pm$\,2.84)\,$\times$\,10$^{10}$\,\Msun, and a gas-to-dynamical mass fraction of $f_\textrm{gas-to-dyn}$ = 0.35\,$\pm$\,0.14, consistent with those of other SMGs \citep{Tacconi06a}.  We note that a derived dynamical mass based on this assumption is likely to be biased towards low values, as the CO-emitting region can be spatially more extended than the dust emitting region due to the low dust optical depth at larger radii. 
{\bf This is supported by recent studies, in which a range of CO source size ranging from $\sim$4$-$20 kpc has been found \citep{Tacconi06a, Ivison11a, Riechers11c, Hodge13a}}. 
...
with a sample of SMGs which are selected at 850~$\micron$ and are typically unlensed or only weakly magnified \citep[][hereafter B13]{Bothwell13a}. 
Their properties are listed in Table~\ref{tab:compareSMG}, which clearly demonstrates that SMM\,J0939 has properties similar
...
Given that the gas properties in their sample are based on unresolved emission of various higher-$J$ CO transitions, we additionally compare SMM\,J0939 to two other exceptionally submm-bright,
strongly-lensed SMGs
found at similar redshifts --- HLSW-01 and the cosmic Eyelash, both of which are well-studied and their properties are derived using similar approach employed in this paper.}
...
{\bf 
We note that the gas mass in SMM\,J0939 is slightly lower than the median in the B13 sample, which might be indicative of a 
lower gas excitation than we have assumed. Yet, we find that the amount of gas in SMM\,J0939 is consistent with other type-2 quasars. 
As such, given the presence of an obscured quasar and the overlap of properties 
with both populations,
%, in which SMM\,J0939 harbors a massive gas reservoir with an immense star formation rate and low depletion timescale of gas, 
a physical interpretation might be that SMM\,J0939 is transitioning from its short, star-bursting phase to the unobscured quasar phase in the proposed evolutionary link model \citep[\eg][]{Sanders88,Coppin08a,Simpson12a}. 
Further investigate on the gas excitation with spatially resolved \rot[CO]{1}{0} line measurements will provide a 
more constraining representation of the amount of cold gas present in SMM\,J0939, as well as the impact of differential lensing, which will enable a better understanding of the two galaxy populations at high-redshifts.
}
...
\bibitem[{Bussmann {et~al.}(2015)Bussmann, Leung, \& Conley}]{uvmcmcfit15a}
Bussmann, S., Leung, T. K.~D., \& Conley, A. 2015, uvmcmcfit,
