...
SMM\,J0939+8315 hosts a type-2 quasar, and is gravitationally lensed by the radio galaxy 3C220.3 and its companion galaxy at $z$ = 0.685.
...
Detections of C~{\scriptsize\sc IV}~1549\AA\
...
where $n$ is a positive integer. The blue crosses correspond to the centroid locations of the lensing knots detected in the SMA 1\,mm continuum emission (see Figure \ref{fig:mom0}). The central cross on each panel indicates the position of the radio core of 3C220.3. \label{fig:cont}}
\end{figure*}
