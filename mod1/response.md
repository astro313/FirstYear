We thank the referee for providing constructive and useful comments to improve this manuscipt. We have addressed all the concerns raised by the referee and details can be found in the revised version -- please see attached. A brief description on how we incoprated the changes can be found below. 
...
> We picked out two gravitaitonally lensed SMGs to show the ranges of SMGs properties, of which intrinsically sit at faint ends of the luminosity distribution, and thus is not studies in sensitivity-limited samples. 
...
> Greve+05 report a range of depletion time τ = 40-100 Myr. 

~~~ python
# Taken into account one of the comments listed above, we added literature reference to Table 4, and the depletion time scale is consistent with other SMGs. Greve+05 report a range of depletion time τ = 40-100 Myr. 
~~~
2:
...
> We were unable to make adjustment to this point as we did not use orange in the figure. Please kindly clarify this. 
