...
theta_guess = [4321., 0.19, 3.e6, 3.e12]    # dummy, (CLEARY 2007 0.19, 3.e6, 3.e12)
...
extrapolate_mJy = lobeSyn(x_syn_extend, *theta_best)    # extrapolate the fit to 104 GHz
...
core_fit_3c6dot1, core_fit_3c6dot1_covar = curve_fit(powerlaw, Core_3c6dot1_freq, Core_3c6dot1_Jy,
    [0.53746,-0.18853])

core_fit_3c263, core_fit_3c263_covar = curve_fit(powerlaw,
    Core_3c263_freq, Core_3c263_Jy,
    [283943., -0.6444])
...
fitParams, fitCovariances = \
    curve_fit(B_nu, freq_Hz[-4:], SMGflux_SI[-4:], [1.0e12, 1])       # simple MBB fit using known params
...
plt.plot(x_extend*Hz2GHz, y_SMG_extend*SI2Jy*Jy2mJy, 'b--',
