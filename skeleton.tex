...
% online said;: should go in alphabetical order, so should I do Ivison 11 before R11?
...
\hspace{-1cm}
\includegraphics[width=1.15\textwidth]{Figure/CorrelationPlot__thick_500_500_cmyk}
\end{minipage}
\hspace{-0.9cm}
\begin{minipage}{0.5\textwidth}
\includegraphics[width=1.15\textwidth]{Figure/CorrelationPlot__thin_testSMA_cmyk.pdf}
\end{minipage}
