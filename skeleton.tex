...
% typical of local ULIRGs is ~ 100)
%\citep{Riechers11b}
...
%CO L ratio provides an indication of the SFE. Strong starburst and ULIRGs tend to show high IR-to-CO L ratios of $\gtrsim$ 
%100 L$\sun$ ( K km/s pc2)-1 \citep[\eg][]{Solomon05a}. 
...
%Note: SFE values for ULIRGs and distant SMGs typically exceed 100 \Lsun [K km/s pc$^2$]\pmOne
%(\eg Yao et al. 2003; Neri et al. 2003; Greve et al. 2005; Bouche et al. 2007).
