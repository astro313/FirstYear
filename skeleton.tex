...
The underlying continuum emission toward the foreground radio galaxy 3C220.3, at $z$ = 0.685, is detected with an integrated flux density of $S_\textrm{cont}$ = 7.4\,$\pm$\,1.42 mJy. 
Using the \CO line intensity of $I_\textrm{CO(3-2)}$ = (10.1\,$\pm$\,1.3)\,Jy\,km\,s\pmOne, we derive 
 a lensing- and excitation-corrected CO line luminosity of \Lp = (2.7\,$\pm$\,0.6) $\times$\,10$^{10}$\,(10.1/$\mu_\textrm{L}$)\,\LpU, where $\mu_\textrm{L}$ is the lensing magnification factor inferred from our lens modeling performed on the archival 1\,mm continuum emission. 
 This translates to a molecular gas mass of $M_\textrm{gas}$\,=\,(2.3\,$\pm$\,0.5)\,$\times$\,10$^{10}$\,\Msun. 
Fitting the SED models to the (sub)-millimeter data of this SMG yields a rest-frame dust temperature of $T_\textrm{dust}$ = 
63.1$^{+1.1}_{-1.3}$\,K, a dust mass of $M_\textrm{dust}$ = (5.2\,$\pm$\,2.1)\,$\times$\,10$^8$\,\Msun, and a total infrared luminosity of 
$L_\textrm{IR}$ = (9.1\,$\pm$\,1.2)\,$\times$10$^{12}$\,\Lsun, after correcting for lensing magnification.
Our comparative study 
of the intrinsic properties (\eg gas mass, dust mass, star formation rate, and surface densities) in SMM
J0939+8315 
and other high-redshift SMGs and type-2 quasars suggests that SMM\,J0939+8315 is a faithful representation of both populations. 
SMM\,J0939+8315 may be transitioning from its star-bursting phase to the unobscured quasar phase in the currently favored evolutionary link model.
\end{abstract}
...
averaging over all line-free channels, this yields a synthesized clean beam of 12\farcs0\,$\times$\,6\farcs5, $-$55.9$\degr$ east of north, and an rms noise of $\sigma_\textrm{cont}$ = 0.50\,\,mJy\,\,beam\pmOne.
...
is (8\farcs4\,$\pm$\,1\farcs1)\,$\times$\,(4\farcs9\,$\pm$\,0\farcs6) at $-$53.8$\degr$, and the integrated flux density is 7.53\,$\pm$\,1.42\,\,mJy. An overlay image of the 104 GHz  
...
Top Right: Velocity-integrated \CO line emission (red contours) overlaid on the SMA 1\,mm dust continuum (green contours and grayscale; H14) with $\sigma_\textrm{1\,mm}$\,=\,0.84 mJy beam\pmOne. The beam size of the SMA observations is 1\farcs4$ \times $1\farcs2, P.A. $-$34\degr, as shown 
