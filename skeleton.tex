...
5\farcs8 for the upper sideband image cube. The final rms noise is $\sigma$ = 0.7 Jy km s\pmOne $\rm beam^{-1}$ over channel width of 145.8 MHz (corresponding to $\sim$407 km s\pmOne). The continuum image is created by
...
\begin{figure}[!tbph]
\centering
\includegraphics[width=0.5\textwidth]{Figure/3C220_3_FullSED}
