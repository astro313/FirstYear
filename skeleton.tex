...
The radio galaxy 3C220.3 at $z$ = 0.685 acts as a gravitational lens of this SMG, which hosts a type-2 quasar.
...
Using the \CO line intensity of $I_\textrm{CO(3-2)}$ = (10.1\,$\pm$\,1.3)\,Jy\,km\,s\pmOne, we derive
 a lensing- and excitation-corrected CO line luminosity of \Lp = (2.7\,$\pm$\,0.6) $\times$\,10$^{10}$\,(10.1/$\mu_\textrm{L}$)\,\LpU, where $\mu_\textrm{L}$ is the lensing magnification factor inferred from our lens modeling performed on the 1\,mm continuum emission.
 This translates to a molecular gas mass of $M_\textrm{gas}$ = (2.2\,$\pm$\,0.5)\,$\times$\,10$^{10}$\,\Msun.
...
averaging over all line-free channels, this yields a synthesized clean beam of 12\farcs0\,$\times$\,6\farcs5, $-$55.9$\degr$ east of north, and an rms noise of $\sigma_\textrm{cont}$ = 0.50\,\,mJy\,\,beam\pmOne over 7.BLAH GHz
